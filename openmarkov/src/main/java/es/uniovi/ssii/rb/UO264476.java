...
public class UO264476 {

	private ProbNet probNet;
	private Long seed;
	private Random rnd;

	public UO264476(String fileName) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		UO264476 obj = new UO264476("asia.pgmx");
		...
		EvidenceCase evidence = new EvidenceCase();
		Variable hasLungCancer = obj.probNet.getVariable("Has lung cancer");
		List<Variable> variablesOfInterest = Arrays.asList(hasLungCancer);
